describe('test configuration gb', function() {

	it('should be able to login as developers_gb', function() {
		...
		login.click();
		//emailLogin.click();
		username.sendKeys('developers_gb');
		password.sendKeys('developers_gb');
		done.click();

		expect(welcome.getText()).toEqual('Welcome back Gordon-Brian');
	});

	it('should be able to go to available_nogb page and see a geo message', function() {
		browser.get('http://www.livestation.com/available_nogb/591dbbd7-e69d-41c6-bf4a-d49cf2afbeb1');
		expect(browser.getCurrentUrl()).toEqual('http://www.livestation.com/available_nogb/591dbbd7-e69d-41c6-bf4a-d49cf2afbeb1');
	...
	it('should be able to go to available_everywhere page and see the channel', function() {
		browser.get('http://www.livestation.com/available_everywhere/62a345e4-9de9-4607-964f-4cf2c17a8057');
		expect(browser.getCurrentUrl()).toEqual('http://www.livestation.com/available_everywhere/62a345e4-9de9-4607-964f-4cf2c17a8057');
