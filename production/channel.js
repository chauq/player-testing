describe('watch a channel', function() {
	...
	it('should be able to go to the station page by clicking on the icon', function() {
		...
		expect(browser.getCurrentUrl()).toEqual('http://www.livestation.com/station/sky_news_international/712d5ee5-867c-4fde-b34e-b48f3fbf3ac0');
	...
	it('should be able to go to the video page by going to a link', function() {
		browser.get('http://www.livestation.com/#/station/sky_news_international/712d5ee5-867c-4fde-b34e-b48f3fbf3ac0');
