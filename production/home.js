describe('lsng home', function() {
	...
	it('should be able to scroll down the home page', function() {
		...
		expect(browser.getCurrentUrl()).toEqual('http://www.livestation.com/home');
	});
...
/*
	it('should be able to go to the trending page by clicking on the icon', function() {
		...
		trending.click();
		expect(browser.getCurrentUrl()).toEqual('http://www.livestation.com/trending');
	});
*/
...
*/
	it('should be able to click on the BBC button and go to the BBC page', function() {
		...
		expect(browser.getCurrentUrl()).toEqual('http://www.livestation.com//bbc_world/8d889d9c-de66-4c82-b9c9-54dcf70dc031');
