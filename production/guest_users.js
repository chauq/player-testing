describe('Guest users', function() {
	...
	it('should be able to go a channel as a guest user', function() {
		browser.get('http://www.livestation.com/france24_english/abf214bc-3fcc-4189-8440-52d2a85083c7');

		expect(browser.getCurrentUrl()).toEqual('http://www.livestation.com/france24_english/abf214bc-3fcc-4189-8440-52d2a85083c7');
	});
	...
	it('should let the guest user in the stations page', function() {
		...
		expect(browser.getCurrentUrl()).toEqual('http://www.livestation.com/stations');
	});
	...
	it('should not let the guest user in the home page', function() {
		browser.get('http://www.livestation.com/home');

		expect(browser.getCurrentUrl()).toEqual('http://www.livestation.com/intro');
	});

	it('should let the guest user in a VOD page', function() {
		browser.get('http://www.livestation.com/EricW/035bfac0-f90b-41b3-856a-f908e8bda277');

		expect(browser.getCurrentUrl()).toEqual('http://www.livestation.com/EricW/035bfac0-f90b-41b3-856a-f908e8bda277');
	});
	...
	it('should let the guest user into a users profile page', function() {
		browser.get('http://www.livestation.com/EricW');

		expect(browser.getCurrentUrl()).toEqual('http://www.livestation.com/EricW');
	});
